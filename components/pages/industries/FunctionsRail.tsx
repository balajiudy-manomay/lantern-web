const ICONS: Record<string, JSX.Element> = {
  ...
  Finance: (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="12" cy="12" r="9" />
      <path d="M12 7v10M15 9.5c0-1.38-1.34-2.5-3-2.5s-3 1.12-3 2.5 1.34 2.5 3 2.5 3 1.12 3 2.5-1.34 2.5-3 2.5-3-1.12-3-2.5" />
    </svg>
  ),
  HR: (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export default function FunctionsRail({ functions }: { functions: string[] }) {
  return (
    <div className="fx-wrap" aria-label="Business functions">
      {functions.map((f) => (
        <div key={f} className="fx-pill">
          <span className="fx-ico">{ICONS[f] ?? DEFAULT_ICON}</span>
