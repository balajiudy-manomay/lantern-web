          ...
          <div className="an-wrap">
            <div className="an-svg-wrap">
              <svg viewBox="0 0 340 460" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <radialGradient id="fg3" cx="50%" cy="35%" r="38%"><stop offset="0%" stopColor="#4a7fc9" stopOpacity=".14" /><stop offset="100%" stopColor="#4a7fc9" stopOpacity="0" /></radialGradient>
                ...
                <path d="M132 68 Q170 28 208 68" fill="none" stroke="#3e6ea5" strokeWidth="4" strokeLinecap="round" />
                <line x1="132" y1="68" x2="132" y2="92" stroke="#3e6ea5" strokeWidth="3.5" />
                <line x1="208" y1="68" x2="208" y2="92" stroke="#3e6ea5" strokeWidth="3.5" />
                <text x="244" y="54" fontFamily="'Inter',sans-serif" fontSize="13" fill="#3e6ea5" fontWeight="700" letterSpacing="1">HANDLE</text>
                <text x="244" y="70" fontFamily="'Inter',sans-serif" fontSize="10" fill="#6a6e7a">Human Wisdom</text>
                <path d="M116 94 Q114 88 132 88 L208 88 Q226 88 224 94 L230 298 Q231 310 214 310 L126 310 Q109 310 110 298 Z" fill="none" stroke="#7a93b8" strokeWidth="2" opacity=".6" />
                ...
                <path d="M170 120 C153 162 150 214 170 244 C190 214 187 162 170 120Z" fill="none" stroke="#4a7fc9" strokeWidth="3.5">
                ...
                <circle cx="170" cy="114" r="6" fill="#4a7fc9" filter="url(#gf3)"><animate attributeName="opacity" values=".5;1;.5" dur="2s" repeatCount="indefinite" /></circle>
                <text x="244" y="170" fontFamily="'Inter',sans-serif" fontSize="13" fill="#4a7fc9" fontWeight="700" letterSpacing="1">FLAME</text>
                <text x="244" y="186" fontFamily="'Inter',sans-serif" fontSize="10" fill="#6a6e7a">AI Intelligence</text>
                <ellipse cx="170" cy="274" rx="36" ry="13" fill="none" stroke="#6a94c4" strokeWidth="1.8" opacity=".5" />
                <text x="20" y="274" fontFamily="'Inter',sans-serif" fontSize="13" fill="#1b4a82" fontWeight="700" letterSpacing="1">FUEL</text>
